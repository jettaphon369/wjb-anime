...
class Board3D{
  ...
  initThree(){
    ...
    const hemi=new THREE.HemisphereLight(0xffffff,0x31523f,1.18);
    this.scene.add(hemi);
    const dir=new THREE.DirectionalLight(0xfff4dc,1.42);
    ...
    this.scene.add(fill);
    const rim=new THREE.DirectionalLight(0xffd7ad,0.42);
