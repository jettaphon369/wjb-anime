...
class Board3D{
  ...
  initThree(){
    ...
    const hemi=new THREE.HemisphereLight(0xdff3ff,0x35522f,0.62);
    this.scene.add(hemi);
    const dir=new THREE.DirectionalLight(0xfff0cf,0.72);
    dir.position.set(-6,10,6);
    dir.castShadow=true;
    dir.shadow.mapSize.set(1024,1024);
    dir.shadow.camera.left=-12; dir.shadow.camera.right=12; dir.shadow.camera.top=10; dir.shadow.camera.bottom=-10;
    this.scene.add(dir);
    const fill=new THREE.DirectionalLight(0xb9d9ff,0.18);
    fill.position.set(7,6,-5);
    this.scene.add(fill);
    const rim=new THREE.DirectionalLight(0xffd7ad,0.10);
